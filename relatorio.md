<h1>Relatório de Level Design - RonRonArte</h1>

<h2>Identificação do grupo e do projeto</h2>
<p>Nome da equipe: CatUp (grupo 3 turma 15)</p>
...
<p>RonRonArte objetiva a interação entre gatos e tutores por meio de uma viagem no tempo nos períodos da arte. Enquanto o gato toca em bichinhos que aparecem nas fases, ele preenche pinturas e, ao final, o tutor pode ver o desempenho do seu pet e informações da obra e do artista em si, que pertence a alguma minoria (diversidade).</p>
...
Caso queira ver o diagrama de cenas no Figma, [clique aqui](https://www.figma.com/design/M9iVkJjgLuhcVnC6v2aUAY/Diagrama-de-Cenas?node-id=0-1&p=f&t=fk8yJVrGBBaLzt2T-0) <br> <br>
...
<p>A fase de tutorial começa com o jogo se comunicando com o jogador através de caixas de texto que são alternadas através de toques na tela. Cada caixa instrui o jogador a como estimular e incentivar o gato a continuar jogando, e também dá algumas informações adicionais sobre o jogo, como enredo, e modos alternativos de jogo.
...
<h2>Level 2: fase 1 - fase contemporânea</h2>
...
<h2>Level 3: fase 2 - fase moderna</h2>
<p>Responsáveis pelo level design: Carlos Eduardo Quaglia, Eduardo Jesus e Luana de Jesus.</p>
...
<h2>Level 5: fase 4 - fase referente à Pré-História</h2>
<p>Responsáveis pelo level design: Carlos Eduardo Quaglia, Eduardo Jesus e Luana de Jesus.</p>
<p>Situação inicial do level: a ser desenvolvido.</p>
<p>Imagem do level:</p>
